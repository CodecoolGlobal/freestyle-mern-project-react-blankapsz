...
* [![Exp][Express]][Express-url]
* [![DB][MongoDB]][Mongo-url]
...
1. Clone the repo
   ```sh
   git clone https://github.com/CodecoolGlobal/freestyle-mern-project-react-blankapsz
   ```
...
Drag and drop the book into the designated removal area.
Manage your favorite books easily with these simple steps!
<p align="right">(<a href="#readme-top">back to top</a>)</p>
